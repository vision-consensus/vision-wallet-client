...
import org.vision.common.crypto.jce.*;
...
public class ECKey implements Serializable, SignInterface {
  ...
  public ECKey(@Nullable BigInteger priv, ECPoint pub) {
    this(VisionCastleProvider.getInstance(), privateKeyFromBigInteger(priv), pub);
  }
  ...
  private static PrivateKey privateKeyFromBigInteger(BigInteger priv) {
    if (priv == null) {
      ...
      try {
        return ECKeyFactory.getInstance(VisionCastleProvider.getInstance())
  ...
  public static byte[] signatureToAddress(byte[] messageHash, String signatureBase64)
      throws SignatureException {
    return org.vision.common.utils.Hash.computeAddress(signatureToKeyBytes(messageHash, signatureBase64));
  }
  ...
  public static byte[] signatureToAddress(byte[] messageHash, ECDSASignature sig)
      throws SignatureException {
    return org.vision.common.utils.Hash.computeAddress(signatureToKeyBytes(messageHash, sig));
  }
  ...
  public static byte[] recoverAddressFromSignature(
    ...
    if (pubBytes == null) {
      ...
      return org.vision.common.utils.Hash.computeAddress(pubBytes);
    }
  }
  ...
  public byte[] getAddress() {
    if (pubKeyHash == null) {
      pubKeyHash = org.vision.common.utils.Hash.computeAddress(this.pub);
    }
    return pubKeyHash;
  }
