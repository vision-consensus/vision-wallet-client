...
//  }
  ...
  public DecryptNotesVRC20 scanShieldedVRC20NoteByIvk(IvkDecryptVRC20Parameters parameters) {
    if (blockingStubSolidity != null) {
  ...
  public DecryptNotesVRC20 scanShieldedVRC20NoteByOvk(OvkDecryptVRC20Parameters parameters) {
    if (blockingStubSolidity != null) {
  ...
  public ShieldedVRC20Parameters createShieldedContractParameters(
      PrivateShieldedVRC20Parameters parameters) {
    return blockingStubFull.createShieldedContractParameters(parameters);
  }

  public ShieldedVRC20Parameters createShieldedContractParametersWithoutAsk(
      PrivateShieldedVRC20ParametersWithoutAsk parameters) {
    return blockingStubFull.createShieldedContractParametersWithoutAsk(parameters);
  }

  public NullifierResult isShieldedVRC20ContractNoteSpent(NfVRC20Parameters prameters) {
    if (blockingStubSolidity != null) {
      return blockingStubSolidity.isShieldedVRC20ContractNoteSpent(prameters);
    } else {
      return blockingStubFull.isShieldedVRC20ContractNoteSpent(prameters);
    }
  }

  public BytesMessage getTriggerInputForShieldedVRC20Contract(
      ShieldedVRC20TriggerContractParameters parameters) {
    return blockingStubFull.getTriggerInputForShieldedVRC20Contract(parameters);
  }
